...
opciones.forEach(opcion => {
    ...
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q17.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q18.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q19.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q20.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q21.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q22.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q23.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q24.appendChild(optionElement);
});
opciones.forEach(opcion => {
    const optionElement = document.createElement('option');
    optionElement.textContent = opcion.texto;
    optionElement.value = opcion.value;
    q25.appendChild(optionElement);
});